...
&nbsp;<font color="white">/</font>
<span class="but"><a href="civil.php">Civil</a></span>
<?php
...
$q1=mysql_query("SELECT * FROM events WHERE category='CE'");
$i=1;
...
if($i%3!=0)
	{
	?>
	<div style="width:50px;height:50px;border:1px solid;border-radius:100px;color:white;cursor:pointer;"   onclick="load_eve('chem')">
<a href="eventview.php?ev=<?php echo $row['ename'];?>&br=<?php echo $row['category'];?>">
	<img src="evimages/CE/<?php echo $row['ename'];?>.png" style="width:50px;height:50px;border-radius:100px">
</a>
</div>
<?php
...
<td>
	...
	{
	?>
	</tr><tr><td><div style="width:50px;height:50px;border:1px solid;border-radius:100px;color:white;cursor:pointer;"   onclick="load_eve('chem')">
<a href="eventview.php?ev=<?php echo $row['ename'];?>&br=<?php echo $row['category'];?>">
	<img src="evimages/CE/<?php echo $row['ename'];?>.png" style="width:50px;height:50px;border-radius:100px">
</a>
</div>
