...
&nbsp;<font color="white">/</font>
<span class="but"><a href="open.php">Open 2 All</a></span>
</div>
...
$q1=mysql_query("SELECT * FROM events WHERE category='OPEN2ALL'");
$i=1;
...
<img src="evimages/OPEN2ALL/<?php echo $row['ename'];?>.png" style="width:50px;height:50px;border-radius:100px">
</a>
</div>
<?php
