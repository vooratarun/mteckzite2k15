...
&nbsp;<font color="white">/</font>
<span class="but"><a href="mme.php">Robotics</a></span>
<?php
...
$q1=mysql_query("SELECT * FROM events WHERE category='MME'");
$i=1;
...
<img src="evimages/MME/<?php echo $row['ename'];?>.png" style="width:50px;height:50px;border-radius:100px">
</a>
</div>
<?php
