...
$q1=mysql_query("SELECT * FROM events WHERE category='ROBOTICS'");
$i=1;
...
<a href="eventview.php?ev=<?php echo $row['ename'];?>&br=<?php echo $row['category'];?>">
	<img src="evimages/ROBOTICS/<?php echo $row['ename'];?>.png" style="width:50px;height:50px;border-radius:100px">
</a>
</div>
<?php
