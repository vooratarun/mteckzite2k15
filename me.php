...
&nbsp;<font color="white">/</font>
<span class="but"><a href="me.php">ME</a></span>
<?php
...
$q1=mysql_query("SELECT * FROM events WHERE category='MECH'");
$i=1;
...
<img src="evimages/MECH/<?php echo $row['ename'];?>.png" style="width:50px;height:50px;border-radius:100px">
</a>
</div>
<?php
