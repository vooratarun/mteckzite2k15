...
&nbsp;<font color="white">/</font>
<span class="but"><a href="cse.php">Cse</a></span>
<?php
...
$q1=mysql_query("SELECT * FROM events WHERE category='CSE'");
$i=1;
...
<img src="evimages/CSE/<?php echo $row['ename'];?>.png" style="width:50px;height:50px;border-radius:100px">
</a>
</div>
<?php
